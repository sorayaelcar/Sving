...
"""
Name: '3 - Sculpted Prims Part II (texturing, video)'
Blender: 248
Group: 'Help'
...
if webbrowser:
    webbrowser.open('http://blog.machinimatrix.org/3d-creation/video-tutorials/sculpties-basic-tutorials/sculpted-prims-part-ii/')
else:
