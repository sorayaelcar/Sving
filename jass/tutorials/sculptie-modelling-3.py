...
"""
Name: '4 - Sculpted Prims Part III (modelling, video)'
Blender: 248
Group: 'Help'
...
if webbrowser:
    webbrowser.open('http://blog.machinimatrix.org/3d-creation/video-tutorials/sculpties-basic-tutorials/sculpted-prims-part-iii/')
else:
