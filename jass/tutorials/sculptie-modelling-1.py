...
"""
Name: '2 - Sculpted Prims Part I (modelling, video)'
Blender: 248
Group: 'Help'
...
if webbrowser:
    webbrowser.open('http://blog.machinimatrix.org/3d-creation/video-tutorials/sculpties-basic-tutorials/modelling-sculpties/')
else:
